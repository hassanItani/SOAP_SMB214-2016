...
class soap_transport_http extends nusoap_base {
	...
	*/
	...
	function connect($connection_timeout=0,$response_timeout=120){
...
//curl_setopt($this->ch, CURLOPT_CAINFO, 'f:\php-4.3.2-win32\extensions\curl-ca-bundle.crt');		
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=120, $cookies=NULL) {
	...
	* @access   public
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=120, $cookies) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=120){
		parent::nusoap_base();
        $this->wsdl = $wsdl;
...
class soapclient2 extends nusoap_base  {
	...
	var $response_timeout = 120;		// HTTP response timeout
	...
	* @access   public
	*/
	function soapclient2($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 120){
		parent::nusoap_base();
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=120) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
